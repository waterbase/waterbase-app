  ...
  this.then(function(next){
    ...
    this.databaseConnection.once('open', function(){
      ...
      for (var resourceName in resources){
        self.createResourceSync(resourceName, resources[resourceName]);
      }
...
Server.prototype.listen = function(port, callback){
  this.then(function(){
    ...
    console.log('setting server config status in listen: ', this.serverConfig.status.port);
    this.serverConfig.save();
...
Server.prototype.createResourceSync = function(resourceName, resource){
  //update serverConfig file
  this.serverConfig.resources[resourceName] = resource;

  //creating model in the server's database
  console.log('Server @@@@@@ creating model', resourceName, resource.attributes);
  this.databaseConnection.model(resourceName, resource.attributes);
...
Server.prototype.updateSchemaSync = function(resourceName, resource){
  //update serverConfig file
  this.serverConfig.resources[resourceName] = resource;

  //creating model in the server's database
  console.log('Server @@@@@@ updating model', resourceName, resource.attributes);

  var schema = this.databaseConnection.model(resourceName).schema;
