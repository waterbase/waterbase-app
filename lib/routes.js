...
module.exports = function(app) {
  ...
  // //collection
  // app.get('/api/database/:database/collection/:collection', middleware.auth, customDatabase.list);
  // app.put('/api/database/:database/collection/:collection', middleware.auth, customDatabase.updateAll);
  // app.del('/api/database/:database/collection/:collection', middleware.auth, customDatabase.removeAll);
  // //create document
  // app.post('/api/database/:database/collection/:collection', middleware.auth, customDatabase.createOne);
  // //collection document
  // app.get('/api/database/:database/collection/:collection/:id', middleware.auth, customDatabase.show);
  // app.put('/api/database/:database/collection/:collection/:id', middleware.auth, customDatabase.updateOne);
  // app.del('/api/database/:database/collection/:collection/:id', middleware.auth, customDatabase.removeOne);
